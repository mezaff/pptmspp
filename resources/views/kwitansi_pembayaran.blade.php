        ...
        <div class="invoice-box ">
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <table>
                        <tr width="100%">
                            <td style="vertical-align: middle;text-align:center;font-weight: bold;font-size:1.5rem" width="300">
                            ...
                            <td style="text-align: center">
                                ...
                                {{ ucfirst(settings()->get('pj_jabatan')) }} <br>
                                @if (request('output') == 'pdf')
                                <img src="{{ storage_path() . '/app/' . settings()->get('pj_ttd') }}" alt="" width="100">
                                @else
                                <img class="text-center" src="{{ \Storage::url(settings()->get('pj_ttd')) }}" alt="Ttd" width="150">
                                @endif
                                <br>
                                <u>{{ ucfirst(settings()->get('pj_nama')) }}</u>
                            </td>
                        </tr>
                    </table>
                </tr>
